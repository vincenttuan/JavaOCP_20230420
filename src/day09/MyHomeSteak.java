...
public class MyHomeSteak {
	...
	public static void main(String[] args) {
		Steak steak1 = new Steak("菲力牛排", 350, Doneness.MEDIUM);
		Steak steak2 = new Steak("丁骨牛排", 550, Doneness.MEDIUM_RARE);
		Steak steak3 = new Steak("牛小排", 450, Doneness.MEDIUM_WELL);
